                                        ...
                                        <div class="tab-pane" id="tab-status_perkawinan" role="tabpanel">
                                            ...
                                            <div class="row col-12">
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <div class="alert alert-danger">
                                                        Untuk jenis kelamin perempuan, kelompok dengan status perkawinan <b><?php foreach($information_marital['max_lfemale_labels'] as $max_lmale_label) { echo $max_lmale_label . ", "; }?></b> adalah kelompok status perkawinan tertinggi dengan jumlah <b><?=$information_marital['lmax_female']?></b> orang atau <b><?=round($information_marital['lcount_lmax_female_percent'])?>%</b> . Sedangkan kelompok dengan status perkawinan <b><?php foreach($information_marital['min_lfemale_labels'] as $min_lfemale_label) { echo $min_lfemale_label . ", "; }?></b> adalah yang terendah dengan jumlah <b><?=$information_marital['lmin_female']?></b> orang atau <b><?=round($information_marital['lcount_lmin_female_percent'])?>%</b>.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="tab-agama" role="tabpanel">
                                            ...
                                            <div class="row col-12">
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <div class="alert alert-danger">
                                                        Untuk jenis kelamin perempuan, kelompok agama <b><?php foreach($information_religion['max_rfemale_labels'] as $max_rmale_label) { echo $max_rmale_label . ", "; }?></b> adalah kelompok agama tertinggi dengan jumlah <b><?=$information_religion['rmax_female']?></b> orang atau <b><?=round($information_religion['rcount_rmax_female_percent'])?>%</b> . Sedangkan kelompok agama <b><?php foreach($information_religion['min_rfemale_labels'] as $min_rfemale_label) { echo $min_rfemale_label . ", "; }?></b> adalah yang terendah dengan jumlah <b><?=$information_religion['rmin_female']?></b> orang atau <b><?=round($information_religion['rcount_rmin_female_percent'])?>%</b>.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
